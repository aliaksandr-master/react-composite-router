...
import { INITIAL_STATE_NAME, getRoutesNamesInSearchingOrder, getRoutesByName, compileStateHash, searchStateByLocation } from './routing';
...
export const selectRouterRoutesByName = () => getRoutesByName();
